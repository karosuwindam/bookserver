...
[0.11.5]
- 2024/08
  - NewRelicで確認できるように導入する
  - log出力をslogに置き換えて、状態処理にする
[0.11.3]
- 2024/07
  - タイムアウト処理により、アップロードの待ち時間が短くなっていたので長くする
[0.11.3]
- 2024/07
  - アップロード処理を変更
[0.11.2]
- 2024/04
  - キャッシュの開いたファイルが残っているのでその部分を修正
  - トレースログを吐き出すように変更
  - ベースコンテナをdebian 11からdebian 12.6へ変更
[0.11.0]
- 2024/04
  - Webページで縦長かつAndroidやiPadの場合はモバイルページにするように変更
  - Web機能で不要な関数を削除
  - shutdownプロセスの変更

[0.11.0]
- 2024/04
  - 閲覧のアクセスを記録するためテーブルを追加
  - ファイルのダウンロード機能を用意
  - 閲覧履歴を順番に表示させる機能を追加
  - モバイルページを作成
...
[0.10.2]
- 2024/04
  - アップロード時のタグ設定ルールが間違っていたので修正
  - 処理結果のステータス確認で、登録してから1分以上たっていない状態のものは残す
  - ステータスの表示ルール変更

[0.10.1]
- 2024/04
  - アップロードの機能制限
  - アップロードのjavascriptアルゴリズム変更
...
- 2024/04
  ...
  - テーブルにバージョンを追加してアップグレード対応するように変更
  - モバイルページ処理を追加
